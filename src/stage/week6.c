...
//Freaks functions
void Week6_Freaks_SetFrame(void *user, uint8_t frame)
{
...
static int32_t Back_Week6_GetX(int x, int y)
{
...
static int32_t Back_Week6_GetY(int x, int y)
{
